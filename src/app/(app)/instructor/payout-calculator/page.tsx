      ...
      <main className="mx-auto max-w-7xl px-4 pb-28 pt-6 sm:px-6 lg:px-8">
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-sm leading-6" style={{ color: '#94a3b8' }}>
              Calculate the monthly Skolr platform share and distribute the instructor pool fairly by watch-time contribution.
            </p>
          </div>
          <Link
            href="/instructor"
        ...
        <div className="grid gap-6 xl:grid-cols-[1.15fr_0.85fr]">
          ...
          >
            ...
            <form onSubmit={handleCalculate} className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => handleInstructorCountChange(e.target.value)}
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    inputMode="decimal"
                    value={skolrPercent}
                    onChange={(e) => setSkolrPercent(e.target.value)}
                    placeholder="40"
                  />
                </div>
                <div>
                  ...
                  <input
                    className="inp"
                    inputMode="decimal"
                    value={instructorPercent}
                    onChange={(e) => setInstructorPercent(e.target.value)}
                    placeholder="60"
                  />
                </div>
              </div>
              ...
              <div
                ...
                style={{ borderColor: 'rgba(148,163,184,0.14)', background: 'rgba(15,23,42,0.42)' }}
              >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          className="inp"
                          inputMode="decimal"
                          value={instructor.watchTime}
                          onChange={(e) => updateInstructor(instructor.id, 'watchTime', e.target.value)}
                          placeholder={timeUnit === 'minutes' ? 'e.g. 240' : 'e.g. 4'}
                        />
                      </div>
                    </div>
                  ))}
              ...
              {errors.length > 0 && submitted && (
                <div
                  ...
                  style={{ borderColor: 'rgba(248,113,113,0.22)', background: 'rgba(127,29,29,0.26)', color: '#fecaca' }}
                >
          ...
          <section className="space-y-6">
            <div
              className="rounded-[28px] border p-5 shadow-2xl sm:p-6"
              style={{ background: 'linear-gradient(180deg, rgba(16,185,129,0.12), rgba(2,6,23,0.96))', borderColor: 'rgba(16,185,129,0.2)' }}
            >
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {[
                  ...
                  <div
                    ...
                    style={{ borderColor: 'rgba(148,163,184,0.12)', background: 'rgba(2,6,23,0.48)' }}
                  >
            ...
            <div
              className="rounded-[28px] border p-5 shadow-2xl sm:p-6"
              style={{ background: 'linear-gradient(180deg, rgba(15,23,42,0.92), rgba(2,6,23,0.96))', borderColor: 'rgba(148,163,184,0.14)' }}
            >
              <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <table className="min-w-full text-left text-sm">
                    ...
                    <tbody>
                      {summary.rows.map((row, index) => (
                        <tr
                          key={row.id}
                          style={{ background: index % 2 === 0 ? 'rgba(15,23,42,0.82)' : 'rgba(2,6,23,0.94)', borderTop: '1px solid rgba(148,163,184,0.12)' }}
                        >
              ...
              <div
                ...
                style={{ borderColor: 'rgba(148,163,184,0.14)', background: 'rgba(15,23,42,0.56)', color: '#cbd5e1' }}
              >
                Formula used:
